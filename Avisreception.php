...
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
  <button type="button" class="btn btn-outline-primary btn-lg"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./Avis.php
" target="_parent">  Envoyer un avis </a></button>&emsp;
<button type="button" class="btn btn-outline-secondary btn-lg"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./ProfileChefdep.php
...
$query=" SELECT * FROM Avis where Avis.Destinataire = '$adresseElectronique'";
