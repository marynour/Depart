...
$cnx=$_SESSION['idcnx'];
  ...
  $query=" SELECT * FROM `Reunion` where idreunion in ( select Reunion.idreunion from reunion,ChefDep where Reunion.idchefdep=ChefDep.idchefdep and ChefDep.idcnx='$cnx')";
  ...
  $i=0;
    while($row = mysqli_fetch_row($result))
    {
      ...
      echo "<tr>";
          ...
          echo "<td>  <a href='#' onclick='edit($row[0], \"$row[3]\", \"$row[4]\", \"$row[5]\", \"$row[6]\" , \"$row[7]\")'> <i data-feather='edit'> </i> </a> <a href='delete.php?idreunion=$row[0]' onClick=\"return confirm('Êtes-vous sûr ? ')\"> <i data-feather='delete'> </i> </a></td>";
          $i++;
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form enctype="multipart/form-data" id="materiel-form" method="post" action="insert.php">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="diaog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="edit-materiel-form" method="post" action="edit.php">
  ...
  <div class="col">
       ...
       <div class="col-md-1">
<button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./ProfileChefdep.php
