...
<h2 class="section-title" style="color:#26277a;"><strong><i><u>ENVOI D'UN AVIS:</u></i></strong></h2>
</div> 

        
<div class="main" align="center">   
  <div style="width:700px;height:1320px;border:3px solid #999999;">
    
      <p class="ridge"> </p>
<form action="Avisenvoi.php" method="post"  ENCTYPE="multipart/form-data">
...
<p><strong>Date avis :</strong></p>         
<input type="Date" name="dateavis"> <br/>
<input class="contact-submit" type="submit" value="Send">
<input class="contact-reset" type="reset" value="Reset"><br>
<button type="button" class="btn btn-outline-secondary btn-lg"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./Avisreception.php
