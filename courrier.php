...
p{
	 color: #333333; font-family: "Helvetica Neue",Arial,sans-serif; font-size: 16px; font-weight: 300; line-height: 1.5625; margin-bottom: 20px;
  margin-left: 1em;
}
 </style> 
 </head>
...
<div class="main" align="center">   
  <div style="width:700px;height:850px;border:3px solid #999999;">
      ...
      <p class="ridge"> </p>
<form action="Courrierenvoi.php" method="post"  ENCTYPE="multipart/form-data">
