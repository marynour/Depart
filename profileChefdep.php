...
$result= mysqli_query($id,$query);     
 $row = mysqli_fetch_array($result,MYSQLI_ASSOC); 
   ?>
  <div align="center">
     <button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./ProfilUtili.php" target="_parent">  Profil </a></button>
            &emsp;&emsp; &emsp; &emsp; &emsp;
           <button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModalCenter"> <a href="./Reunion.php" target="_parent">  Reunion </a></button>
            &emsp;&emsp; &emsp;&emsp;&emsp;&emsp;
             <button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModalCenter"><a href="./Avisreception.php" target="_parent"> Avis </a></button>
            &emsp;&emsp; &emsp; &emsp; &emsp;
            <button type="button" class="btn btn-outline-primary"  data-toggle="modal" data-target="#exampleModalCenter"><a href="./courrierReception.php" target="_parent"> Courrier </a></button>
             &emsp;&emsp; &emsp;&emsp;   
  </div>
  <div class="main">
